...
@dataclass
class RBTree:
    """ Red-Black Tree class, a binary search tree with a few extra rules to keep it balanced
        ...
        Methods:
            search(self, value: int) -> Optional[Node]:
            insert(self, value: int) -> None:
            delete(self, value: int) -> None:
            fill_tree(self, values: Iterable[int]) -> None:
            fill_tree_random(self, values: Iterable[int]) -> None:
            clear(self) -> None:
            print_tree(self) -> None:
            print_tree_inorder(self) -> None:
            print_tree_preorder(self) -> None:
            print_tree_postorder(self) -> None:
            print_tree_color (self) -> None:
            print_level_order (self) -> None:
